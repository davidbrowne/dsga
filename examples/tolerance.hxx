...
namespace dsga
{
	...
	// 
	//	* within_tolerance(x, tolerance) - vectors treated as independent components for checks on x
	//	* within_distance(x, y, tolerance) - vectors treated as a whole for Euclidean distance check on x and y
	//	* within_box(x, y, tolerance) - vectors treated as whole for orthogonal box check on x and y
	//
