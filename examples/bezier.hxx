...
constexpr T quadratic_bezier_ordinate_eval(const dsga::vector_base<W, T, 3, D> &control_points, T t) noexcept
{
...
requires (C > 1)
constexpr dsga::basic_vector<T, C> quadratic_bezier_eval(const dsga::vector_base<W1, T, C, D1> &p0,
...
template <bool W1, dsga::floating_point_scalar T, typename D1,
	bool W2, typename D2, bool W3, typename D3>
constexpr T quadratic_bezier_eval(const dsga::vector_base<W1, T, 1, D1> &p0,
...
template <bool W, dsga::floating_point_scalar T, typename D>
constexpr T quadratic_bezier_ordinate_eval2(const dsga::vector_base<W, T, 3, D> &control_points, T t) noexcept
{
...
template <bool W1, dsga::floating_point_scalar T, std::size_t C, typename D1,
	bool W2, typename D2, bool W3, typename D3>
requires (C > 1)
constexpr dsga::basic_vector<T, C> quadratic_bezier_eval2(const dsga::vector_base<W1, T, C, D1> &p0,
														  const dsga::vector_base<W2, T, C, D2> &p1,
														  const dsga::vector_base<W3, T, C, D3> &p2,
														  T t) noexcept
{
...
template <bool W1, dsga::floating_point_scalar T, typename D1,
	bool W2, typename D2, bool W3, typename D3>
constexpr T quadratic_bezier_eval2(const dsga::vector_base<W1, T, 1, D1> &p0,
								   const dsga::vector_base<W2, T, 1, D2> &p1,
								   const dsga::vector_base<W3, T, 1, D3> &p2,
								   T t) noexcept
{
...
// recursive interpolation approach (de Casteljau algorithm) to show off vector functions and swizzling
template <bool W, dsga::floating_point_scalar T, typename D>
constexpr T cubic_bezier_ordinate_eval(const dsga::vector_base<W, T, 4, D> &control_points, T t) noexcept
{
	// not sure of real type of control_points, so make a basic_vector so we can swizzle
...
requires (C > 1)
constexpr dsga::basic_vector<T, C> cubic_bezier_eval(const dsga::vector_base<W1, T, C, D1> &p0,
													 const dsga::vector_base<W2, T, C, D2> &p1,
													 const dsga::vector_base<W3, T, C, D3> &p2,
...
constexpr T cubic_bezier_eval(const dsga::vector_base<W1, T, 1, D1> &p0,
							  const dsga::vector_base<W2, T, 1, D2> &p1,
							  const dsga::vector_base<W3, T, 1, D3> &p2,
...
template <bool W, dsga::floating_point_scalar T, typename D>
constexpr T cubic_bezier_ordinate_eval2(const dsga::vector_base<W, T, 4, D> &control_points, T t) noexcept
{
	auto t_complement = T(1) - t;
...
template <bool W1, dsga::floating_point_scalar T, std::size_t C, typename D1,
	bool W2, typename D2, bool W3, typename D3, bool W4, typename D4>
requires (C > 1)
constexpr dsga::basic_vector<T, C> cubic_bezier_eval2(const dsga::vector_base<W1, T, C, D1> &p0,
													  const dsga::vector_base<W2, T, C, D2> &p1,
													  const dsga::vector_base<W3, T, C, D3> &p2,
													  const dsga::vector_base<W4, T, C, D4> &p3,
													  T t) noexcept
...
// same as previous function, but specializing for length 1 vector case
template <bool W1, dsga::floating_point_scalar T, typename D1, bool W2, typename D2, bool W3, typename D3, bool W4, typename D4>
constexpr T cubic_bezier_eval2(const dsga::vector_base<W1, T, 1, D1> &p0,
							   const dsga::vector_base<W2, T, 1, D2> &p1,
							   const dsga::vector_base<W3, T, 1, D3> &p2,
							   const dsga::vector_base<W4, T, 1, D4> &p3,
							   T t) noexcept
