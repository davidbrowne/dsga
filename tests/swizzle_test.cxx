...
TEST_SUITE("lvalue swizzle copy assignment")
{
	TEST_CASE("lvalue swizzle copy assignment for 1D and 2D")
	{
		...
		SUBCASE("2D swizzling lvalues")
		{
			...
			CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 0>);
			CHECK_UNARY(dsga::detail::unique_indexes<0, 1>);
			CHECK_UNARY(dsga::detail::unique_indexes<0, 2>);
			CHECK_UNARY(dsga::detail::unique_indexes<0, 3>);
			CHECK_UNARY(dsga::detail::unique_indexes<1, 0>);
			CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 1>);
			CHECK_UNARY(dsga::detail::unique_indexes<1, 2>);
			CHECK_UNARY(dsga::detail::unique_indexes<1, 3>);
			CHECK_UNARY(dsga::detail::unique_indexes<2, 0>);
			CHECK_UNARY(dsga::detail::unique_indexes<2, 1>);
			CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 2>);
			CHECK_UNARY(dsga::detail::unique_indexes<2, 3>);
			CHECK_UNARY(dsga::detail::unique_indexes<3, 0>);
			CHECK_UNARY(dsga::detail::unique_indexes<3, 1>);
			CHECK_UNARY(dsga::detail::unique_indexes<3, 2>);
			CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 3>);
		}
	}
	...
	TEST_CASE("lvalue swizzle copy assignment for 3D")
	{
		...
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 0, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 0, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 0, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 0, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 1, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 1, 1>);
		CHECK_UNARY(dsga::detail::unique_indexes<0, 1, 2>);
		CHECK_UNARY(dsga::detail::unique_indexes<0, 1, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 2, 0>);
		CHECK_UNARY(dsga::detail::unique_indexes<0, 2, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 2, 2>);
		CHECK_UNARY(dsga::detail::unique_indexes<0, 2, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 3, 0>);
		CHECK_UNARY(dsga::detail::unique_indexes<0, 3, 1>);
		CHECK_UNARY(dsga::detail::unique_indexes<0, 3, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 3, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 0, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 0, 1>);
		CHECK_UNARY(dsga::detail::unique_indexes<1, 0, 2>);
		CHECK_UNARY(dsga::detail::unique_indexes<1, 0, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 1, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 1, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 1, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 1, 3>);
		CHECK_UNARY(dsga::detail::unique_indexes<1, 2, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 2, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 2, 2>);
		CHECK_UNARY(dsga::detail::unique_indexes<1, 2, 3>);
		CHECK_UNARY(dsga::detail::unique_indexes<1, 3, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 3, 1>);
		CHECK_UNARY(dsga::detail::unique_indexes<1, 3, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 3, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 0, 0>);
		CHECK_UNARY(dsga::detail::unique_indexes<2, 0, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 0, 2>);
		CHECK_UNARY(dsga::detail::unique_indexes<2, 0, 3>);
		CHECK_UNARY(dsga::detail::unique_indexes<2, 1, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 1, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 1, 2>);
		CHECK_UNARY(dsga::detail::unique_indexes<2, 1, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 2, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 2, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 2, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 2, 3>);
		CHECK_UNARY(dsga::detail::unique_indexes<2, 3, 0>);
		CHECK_UNARY(dsga::detail::unique_indexes<2, 3, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 3, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 3, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 0, 0>);
		CHECK_UNARY(dsga::detail::unique_indexes<3, 0, 1>);
		CHECK_UNARY(dsga::detail::unique_indexes<3, 0, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 0, 3>);
		CHECK_UNARY(dsga::detail::unique_indexes<3, 1, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 1, 1>);
		CHECK_UNARY(dsga::detail::unique_indexes<3, 1, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 1, 3>);
		CHECK_UNARY(dsga::detail::unique_indexes<3, 2, 0>);
		CHECK_UNARY(dsga::detail::unique_indexes<3, 2, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 2, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 2, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 3, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 3, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 3, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 3, 3>);
	...
	TEST_CASE("lvalue swizzle copy assignment for 4D - starting index x or y")
	{
		...
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 0, 0, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 0, 0, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 0, 0, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 0, 0, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 0, 1, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 0, 1, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 0, 1, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 0, 1, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 0, 2, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 0, 2, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 0, 2, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 0, 2, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 0, 3, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 0, 3, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 0, 3, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 0, 3, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 1, 0, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 1, 0, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 1, 0, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 1, 0, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 1, 1, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 1, 1, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 1, 1, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 1, 1, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 1, 2, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 1, 2, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 1, 2, 2>);
		CHECK_UNARY(dsga::detail::unique_indexes<0, 1, 2, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 1, 3, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 1, 3, 1>);
		CHECK_UNARY(dsga::detail::unique_indexes<0, 1, 3, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 1, 3, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 2, 0, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 2, 0, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 2, 0, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 2, 0, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 2, 1, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 2, 1, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 2, 1, 2>);
		CHECK_UNARY(dsga::detail::unique_indexes<0, 2, 1, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 2, 2, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 2, 2, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 2, 2, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 2, 2, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 2, 3, 0>);
		CHECK_UNARY(dsga::detail::unique_indexes<0, 2, 3, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 2, 3, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 2, 3, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 3, 0, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 3, 0, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 3, 0, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 3, 0, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 3, 1, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 3, 1, 1>);
		CHECK_UNARY(dsga::detail::unique_indexes<0, 3, 1, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 3, 1, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 3, 2, 0>);
		CHECK_UNARY(dsga::detail::unique_indexes<0, 3, 2, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 3, 2, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 3, 2, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 3, 3, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 3, 3, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 3, 3, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<0, 3, 3, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 0, 0, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 0, 0, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 0, 0, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 0, 0, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 0, 1, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 0, 1, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 0, 1, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 0, 1, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 0, 2, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 0, 2, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 0, 2, 2>);
		CHECK_UNARY(dsga::detail::unique_indexes<1, 0, 2, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 0, 3, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 0, 3, 1>);
		CHECK_UNARY(dsga::detail::unique_indexes<1, 0, 3, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 0, 3, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 1, 0, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 1, 0, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 1, 0, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 1, 0, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 1, 1, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 1, 1, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 1, 1, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 1, 1, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 1, 2, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 1, 2, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 1, 2, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 1, 2, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 1, 3, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 1, 3, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 1, 3, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 1, 3, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 2, 0, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 2, 0, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 2, 0, 2>);
		CHECK_UNARY(dsga::detail::unique_indexes<1, 2, 0, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 2, 1, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 2, 1, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 2, 1, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 2, 1, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 2, 2, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 2, 2, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 2, 2, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 2, 2, 3>);
		CHECK_UNARY(dsga::detail::unique_indexes<1, 2, 3, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 2, 3, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 2, 3, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 2, 3, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 3, 0, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 3, 0, 1>);
		CHECK_UNARY(dsga::detail::unique_indexes<1, 3, 0, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 3, 0, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 3, 1, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 3, 1, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 3, 1, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 3, 1, 3>);
		CHECK_UNARY(dsga::detail::unique_indexes<1, 3, 2, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 3, 2, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 3, 2, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 3, 2, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 3, 3, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 3, 3, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 3, 3, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<1, 3, 3, 3>);
	}
	...
	TEST_CASE("lvalue swizzle copy assignment for 4D - starting index z or w")
	{
		...
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 0, 0, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 0, 0, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 0, 0, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 0, 0, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 0, 1, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 0, 1, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 0, 1, 2>);
		CHECK_UNARY(dsga::detail::unique_indexes<2, 0, 1, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 0, 2, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 0, 2, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 0, 2, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 0, 2, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 0, 3, 0>);
		CHECK_UNARY(dsga::detail::unique_indexes<2, 0, 3, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 0, 3, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 0, 3, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 1, 0, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 1, 0, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 1, 0, 2>);
		CHECK_UNARY(dsga::detail::unique_indexes<2, 1, 0, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 1, 1, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 1, 1, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 1, 1, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 1, 1, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 1, 2, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 1, 2, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 1, 2, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 1, 2, 3>);
		CHECK_UNARY(dsga::detail::unique_indexes<2, 1, 3, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 1, 3, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 1, 3, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 1, 3, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 2, 0, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 2, 0, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 2, 0, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 2, 0, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 2, 1, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 2, 1, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 2, 1, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 2, 1, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 2, 2, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 2, 2, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 2, 2, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 2, 2, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 2, 3, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 2, 3, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 2, 3, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 2, 3, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 3, 0, 0>);
		CHECK_UNARY(dsga::detail::unique_indexes<2, 3, 0, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 3, 0, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 3, 0, 3>);
		CHECK_UNARY(dsga::detail::unique_indexes<2, 3, 1, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 3, 1, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 3, 1, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 3, 1, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 3, 2, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 3, 2, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 3, 2, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 3, 2, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 3, 3, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 3, 3, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 3, 3, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<2, 3, 3, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 0, 0, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 0, 0, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 0, 0, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 0, 0, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 0, 1, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 0, 1, 1>);
		CHECK_UNARY(dsga::detail::unique_indexes<3, 0, 1, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 0, 1, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 0, 2, 0>);
		CHECK_UNARY(dsga::detail::unique_indexes<3, 0, 2, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 0, 2, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 0, 2, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 0, 3, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 0, 3, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 0, 3, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 0, 3, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 1, 0, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 1, 0, 1>);
		CHECK_UNARY(dsga::detail::unique_indexes<3, 1, 0, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 1, 0, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 1, 1, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 1, 1, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 1, 1, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 1, 1, 3>);
		CHECK_UNARY(dsga::detail::unique_indexes<3, 1, 2, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 1, 2, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 1, 2, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 1, 2, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 1, 3, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 1, 3, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 1, 3, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 1, 3, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 2, 0, 0>);
		CHECK_UNARY(dsga::detail::unique_indexes<3, 2, 0, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 2, 0, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 2, 0, 3>);
		CHECK_UNARY(dsga::detail::unique_indexes<3, 2, 1, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 2, 1, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 2, 1, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 2, 1, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 2, 2, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 2, 2, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 2, 2, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 2, 2, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 2, 3, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 2, 3, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 2, 3, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 2, 3, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 3, 0, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 3, 0, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 3, 0, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 3, 0, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 3, 1, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 3, 1, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 3, 1, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 3, 1, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 3, 2, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 3, 2, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 3, 2, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 3, 2, 3>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 3, 3, 0>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 3, 3, 1>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 3, 3, 2>);
		CHECK_UNARY_FALSE(dsga::detail::unique_indexes<3, 3, 3, 3>);
	}
}
...
TEST_SUITE("test swizzling applications")
{
	TEST_CASE("type traits tests")
	{
		...
		SUBCASE("type traits for indexed_vector_const_iterator")
		{
		...
		SUBCASE("type traits for indexed_vector_iterator")
		{
